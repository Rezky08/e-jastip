...
@section("main")
    <form method="POST">
        ...
        <x-wrapper.form isRow>
            ...
            <x-wrapper.column>
                <x-form.select-api name="university_id" label="Universitas" isGroup url="/api/master/university" />
            </x-wrapper.column>
            <x-wrapper.column>
        ...
        <x-wrapper.form isRow>
            <x-wrapper.column>
                <x-form.select-api name="study_program_id" label="Jurusan" isGroup url="/api/master/study-program" />
            </x-wrapper.column>
            <x-wrapper.column>
