...
return [
    ...
    'order.status.invalid' => 'Order harus dalam status :status, sekarang dalam status :current_status',
    'order.transaction.taken' => 'Transaksi :id sudah pernah diambil sebelumnya',
