...
class Order extends Model implements TransactionLogableContract,AttachableContract
{
    ...
    static public function getAvailableStatus(): array
    {
        return [
            ...
            self::ORDER_STATUS_LEGAL_PROCESS => "Proses Legalisasi",
            self::ORDER_STATUS_LEGAL_PROCESS_DONE => "Selesai Legalisasi",
            self::ORDER_STATUS_SHIPPING_PREP => "Persiapan Pengiriman",
            self::ORDER_STATUS_SHIPPING_PREP_DONE => "Siap Dikirim",
