...
class LegalDoneController extends Controller
{
    ...
    public function store(Request $request, Order $order)
    {
        DB::transaction(function () use ($order,$request) {
            try {
                ...
                $job = new SprinterLegalDone($user, $order,$request->all());
                $this->dispatch($job);
            } catch (\Exception $e) {
        ...
        ToastSupport::add(__('messages.sprinter.form.submit.legal_process_done'), __('messages.sprinter.order.ongoing'));
