...
use App\Jobs\Transaction\Order\SprinterLegalDone;
use App\Jobs\Transaction\Order\SprinterPacking;
use App\Jobs\Transaction\Order\SprinterToShipmentPartner;
...
class ToShipmentPartnerController extends Controller
{
    ...
    public function store(Request $request, Order $order)
    {
        DB::transaction(function () use ($order,$request) {
            try {
                ...
                $job = new SprinterToShipmentPartner($user, $order);
                $this->dispatch($job);
            } catch (\Exception $e) {
        ...
        ToastSupport::add(__('messages.sprinter.form.submit.to_shipment_partner'), __('messages.sprinter.order.ongoing'));
